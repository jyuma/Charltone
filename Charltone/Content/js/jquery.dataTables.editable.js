...
(function ($) {
    ...
    $.fn.makeEditable = function (options) {
        ...
        function fnShowError(errorText, action) {
            //--- jc - april-06-2013 - suppress errors
            //alert(errorText);
        }
        ...
        function _fnApplyEditable(aoNodes) {
            ...
            var oDefaultEditableSettings = {
                ...
                "callback": function (sValue, settings) {
                    ...
                    var status = "";
                    //--- jc - april-06-2013 (begin)
                    sNewCellValue = sNewCellValue.trim();
                    sNewCellValue = sNewCellValue.replace(/&/g, '&amp;')
                                                 .replace(/</g, '&lt;')
                                                 .replace(/>/g, '&gt;')
                                                 .replace(/ /g, '&nbsp;');
                    //--- jc - april-06-2013 (end)
                    if (sNewCellValue == sValue) {
                        var aPos = oTable.fnGetPosition(this);
                        //--- jc - april-06-2013 (begin)
                        sNewCellDisplayValue = sNewCellDisplayValue.trim();
                        sNewCellDisplayValue = sNewCellDisplayValue.replace(/&/g, '&amp;')
                                                                    .replace(/</g, '&lt;')
                                                                    .replace(/>/g, '&gt;')
                                                                    .replace(/ /g, '&nbsp;');
                        //--- jc - april-06-2013 (end)
