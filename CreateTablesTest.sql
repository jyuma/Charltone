...
IF OBJECT_ID ('Charltone_Test.dbo.FK_Product_Photo') IS NOT NULL 
ALTER TABLE [dbo].[Photo] DROP CONSTRAINT FK_Product_Photo; 

IF OBJECT_ID ('Charltone_Test.dbo.FK_Instrument_InstrumentType') IS NOT NULL 
ALTER TABLE [dbo].[Instrument] DROP CONSTRAINT FK_Instrument_InstrumentType; 

IF OBJECT_ID ('Charltone_Test.dbo.FK_Instrument_Classification') IS NOT NULL 
ALTER TABLE [dbo].[Instrument] DROP CONSTRAINT FK_Instrument_Classification; 

IF OBJECT_ID ('Charltone_Test.dbo.FK_Instrument_SubClassification') IS NOT NULL 
ALTER TABLE [dbo].[Instrument] DROP CONSTRAINT FK_Instrument_SubClassification; 

IF OBJECT_ID ('Charltone_Test.dbo.FK_Product_Instrument') IS NOT NULL 
ALTER TABLE [dbo].[Product] DROP CONSTRAINT FK_Product_Instrument; 

IF OBJECT_ID ('Charltone_Test.dbo.FK_Product_Status') IS NOT NULL 
ALTER TABLE [dbo].[Product] DROP CONSTRAINT FK_Product_Status; 

IF OBJECT_ID ('Charltone_Test.dbo.FK_Product_ProductType') IS NOT NULL 
ALTER TABLE [dbo].[Product] DROP CONSTRAINT FK_Product_ProductType; 

IF OBJECT_ID ('Charltone_Test.dbo.AdminUser','U') IS NOT NULL DROP TABLE [dbo].[AdminUser];
...
IF OBJECT_ID ('Charltone_Test.dbo.ProductType','U') IS NOT NULL DROP TABLE [dbo].[ProductType];
...
IF OBJECT_ID ('Charltone_Test.dbo.InstrumentType','U') IS NOT NULL DROP TABLE [dbo].[InstrumentType];
...
IF OBJECT_ID ('Charltone_Test.dbo.Classification','U') IS NOT NULL DROP TABLE [dbo].[Classification];
...
IF OBJECT_ID ('Charltone_Test.dbo.SubClassification','U') IS NOT NULL DROP TABLE [dbo].[SubClassification];
...
IF OBJECT_ID ('Charltone_Test.dbo.ProductStatus','U') IS NOT NULL DROP TABLE [dbo].[ProductStatus];
...
IF OBJECT_ID ('Charltone_Test.dbo.Instrument','U') IS NOT NULL DROP TABLE [dbo].[Instrument];
...
IF OBJECT_ID ('Charltone_Test.dbo.Product','U') IS NOT NULL DROP TABLE [dbo].[Product];
...
IF OBJECT_ID ('Charltone_Test.dbo.Photo','U') IS NOT NULL DROP TABLE [dbo].[Photo];
...
IF OBJECT_ID ('Charltone_Test.dbo.NoPhotoImage','U') IS NOT NULL DROP TABLE [dbo].[NoPhotoImage];
...
IF OBJECT_ID ('Charltone._Test.dbo.Ordering','U') IS NOT NULL DROP TABLE [dbo].[Ordering];
...
INSERT INTO HomePageImage(Data, SortOrder) VALUES(' ', 1);
--- Home Page Image ---
INSERT INTO HomePageImage(Id, Data)
SELECT * FROM
